        ...
        <ul cass="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ml-3 text-left whitespace-nowrap">Collection</span>
            ...
            <li>
                <a href="/collector/collectors"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <span class="material-symbols-outlined">
                        groups
                    </span>
                    <span class="flex-1 ml-3 whitespace-nowrap">Collectors</span>
                </a>
            </li>
            <li>
                <a href="/collector/settings"
                    class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    <span class="material-symbols-outlined">
                        manage_accounts
                    </span>
